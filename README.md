...
![version](https://img.shields.io/static/v1?label=version&message=0.55.19&color=blue) <!-- x-release-please-version --> ![for](https://img.shields.io/badge/for-Claude%20Code-8A2BE2) ![mode](https://img.shields.io/badge/modes-local%20%C2%B7%20headless-success) ![eyes](https://img.shields.io/badge/eyes-cross--family%20(Claude%20%2B%20Codex)-orange)
