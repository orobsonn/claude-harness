...
export const FRESH_NATIVE_PATHS = {
  ...
  pi: [
    ...
    ".pi/harness/runtime-defaults/harness.json",
...
const REQUIRED_PI_SOURCE = [
  ...
  { rel: "runtime/harness.json", kind: "file" },
  ...
  { rel: "lib/memory-cycle.mjs", kind: "file" },
  ...
  { rel: "lib/pi-review-concurrency.mjs", kind: "file" },
  { rel: "lib/pi-review-evidence.mjs", kind: "file" },
  ...
  { rel: "lib/release-only.mjs", kind: "file" },
  ...
  { rel: "extensions/harness-reviews.ts", kind: "file" },
  ...
  { rel: "extensions/harness-memory.ts", kind: "file" },
