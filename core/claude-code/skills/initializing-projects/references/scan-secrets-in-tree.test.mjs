...
// Dual-runtime: core/claude-code/skills/.../references/ → ../../../../../ (repo root).
// Legacy flat: core/skills/.../references/ → ../../../../
const REPO_ROOT = existsSync(resolve(__dirname, "../../../../../package.json"))
  ? resolve(__dirname, "../../../../..")
  : resolve(__dirname, "../../../..");
...
test("locked-2: real repo tree (core/rules/ and *.md excluded) reports ZERO findings", () => {
  ...
  // Dual-runtime: real rules live at core/claude-code/rules/ (core/rules is a compat symlink
