...
import { absolutionPrefix, formatFeatureTaskEntry } from "../../shared/lib/absolution.mjs";
import { hasFidelityPass } from "../../opencode/lib/entry-decide.mjs";
import {
  VACUOUS_GREEN_EXIT,
  ...
  spawnAgentName,
  validateSpawnAgent,
} from "../../opencode/hands/run-hand.mjs";
