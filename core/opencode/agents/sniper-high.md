---
description: Surgical fix for HIGH-severity defects (race condition, security, data corruption, auth-bypass). Strong fixer (Qwen). Minimum delta only, no new files.
mode: subagent
model: xai/grok-4.5
temperature: 0.1
permission:
