---
description: Instalar, atualizar ou sincronizar o Claude Harness neste projeto (lane de lifecycle, sem cerimônia).
agent: harness-config
---

Load the `updating-harness` skill and follow only it.
