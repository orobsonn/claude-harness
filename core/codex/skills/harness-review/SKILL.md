...
`node -e 'import("./.codex/lib/review-contracts.mjs")'`; the module is a pure
...
adversarial method and `.codex/skills/harness-delivery/references/delivery-contract.md` for completion evidence.
