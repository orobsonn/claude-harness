...
contract at `.codex/skills/harness-delivery/references/delivery-contract.md`
and the safety contract at `.codex/skills/harness-rules/references/governance-contract.md`.
