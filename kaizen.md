...
- **Promoção:** confirmar em tarefas subsequentes ausência de re-dispatch causado apenas por informação disponível ao pai e medir chamadas/tokens/tempo, preservando detecção de defeitos reais. A mudança ainda é proposta; o patch v2.6.1 tratou ordem commit/revisores e diagnóstico de captura.
