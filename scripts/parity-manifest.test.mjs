...
const OC_FROZEN_MODULES = {
  ...
  "plugin/lib/regate-arm.mjs": { current_path: "plugin/lib/regate-arm.mjs", verdict: "REWRITE" },
...
const OC_MODULE_NORMATIVE_METADATA = {
  ...
  "plugin/lib/regate-arm.mjs": { failure_policy: "idempotent fact write; after-hook failure logs and opens", tests: ["core/opencode/plugin/lib/regate-arm.test.mjs"] },
...
const OC_MODULE_NORMATIVE_REASONS = {
  ...
  "plugin/lib/regate-arm.mjs": "Preserves the re-gate obligation without count machinery.",
...
const OC_RULE_SEMANTICS = {
  ...
  R6: {
    ...
    implementation_targets: ["plugin/entry-gate.ts", "plugin/lib/bash-decide.mjs", "lib/entry-decide.mjs", "lib/gate-state.mjs", "plugin/lib/is-delivery-command.mjs", "plugin/lib/regate-arm.mjs", "plugin/lib/session-state.mjs", "plugin/marker-authority.ts"],
