...
const OC_FROZEN_MODULES = {
  ...
  "lib/retired-files.mjs": { current_path: "lib/retired-files.mjs", verdict: "KEEP" },
...
const OC_MODULE_NORMATIVE_METADATA = {
  ...
  "lib/retired-files.mjs": { failure_policy: "fixed literal ledger; callers intersect it with their exact operation before deleting", tests: ["core/claude-code/skills/initializing-projects/references/vendor-core.test.mjs", "core/opencode/tools/lifecycle-ship.test.mjs"], cc_op: ["CC_OP:core/claude-code/skills/initializing-projects/references/vendor-core.mjs"] },
...
const OC_MODULE_NORMATIVE_REASONS = {
  ...
  "lib/retired-files.mjs": "A finite vendor ledger lets the first update of an old install commit only known retired harness paths.",
