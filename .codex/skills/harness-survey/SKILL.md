...
Apply `.codex/skills/harness-delivery/references/delivery-contract.md` to turn
unknowns into a plan and `.codex/skills/harness-rules/references/governance-contract.md` to flag risks.
